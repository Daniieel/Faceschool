<div class="container" style="margin-top:30px; margin-bottom:60px;">
	<div class="row">
		...
		<div class = "col-md-12">
			<form class="form-horizontal" role="form" action="<?= base_url('administracion/datos_simce_2med_action')  ?>" method="post">
				...
				<div class="form-group">
			  	...
			  	<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      		<input type="text" name="comprension_lectura" class="form-control" id="inputEmail3">
			    	</div>
			  	</div>
