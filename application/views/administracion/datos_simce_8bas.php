<div class="container" style="margin-top:30px; margin-bottom:60px;">
	<div class="row">
		...
		<div class = "col-md-12">
			<form class="form-horizontal" role="form" action="<?= base_url('administracion/datos_simce_8bas_action')  ?>" method="post">
				...
				<div class="form-group">
			  	...
			  	<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      		<input type="text" name="compresion_lectura" class="form-control" id="inputEmail3">
			    	</div>
			  	</div>
			  	...
			  	<div class="form-group">
			    	<label for="inputEmail3" class="col-sm-2 control-label">Ciencias Naturales</label>
			    	<div class="col-sm-10">
			      		<input type="text" name="ciencias_naturales" class="form-control" id="inputEmail3">
			    	</div>
			  	</div>			  			  	
